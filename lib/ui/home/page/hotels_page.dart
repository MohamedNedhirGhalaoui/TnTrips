        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                BuildIcon(color: HOTELS, icon: this.hotels[0].icon),
                SizedBox(
                  width: 10.0,
                ),
              ],
